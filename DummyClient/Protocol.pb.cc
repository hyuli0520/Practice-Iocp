...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ENTER_GAME, _impl_.playerinfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_CHAT, _impl_.playerinfo_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 15, -1, -1, sizeof(::Protocol::C_LEAVE_GAME)},
  { 21, -1, -1, sizeof(::Protocol::S_LEAVE_GAME)},
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Struct.proto\"8\n\014C_ENTER_GAME\022(\n\nplayerIn"
  "fo\030\001 \001(\0132\024.Protocol.PlayerInfo\"E\n\014S_ENTE"
  "R_GAME\022\017\n\007success\030\001 \001(\010\022$\n\006player\030\002 \001(\0132"
  "\024.Protocol.PlayerInfo\"\016\n\014C_LEAVE_GAME\"\016\n"
  "\014S_LEAVE_GAME\"0\n\007S_SPAWN\022%\n\007players\030\001 \003("
  "\0132\024.Protocol.PlayerInfo\"\036\n\tS_DESPAWN\022\021\n\t"
  "playerIds\030\001 \003(\005\"2\n\006C_MOVE\022(\n\nplayerInfo\030"
  "\001 \001(\0132\024.Protocol.PlayerInfo\"2\n\006S_MOVE\022(\n"
  "\nplayerInfo\030\001 \001(\0132\024.Protocol.PlayerInfo\""
  "\025\n\006C_CHAT\022\013\n\003msg\030\001 \001(\t\"\?\n\006S_CHAT\022(\n\nplay"
...
class C_ENTER_GAME::_Internal {
 public:
  static const ::Protocol::PlayerInfo& playerinfo(const C_ENTER_GAME* msg);
};

const ::Protocol::PlayerInfo&
C_ENTER_GAME::_Internal::playerinfo(const C_ENTER_GAME* msg) {
  return *msg->_impl_.playerinfo_;
}
void C_ENTER_GAME::clear_playerinfo() {
...
class S_CHAT::_Internal {
 public:
  static const ::Protocol::PlayerInfo& playerinfo(const S_CHAT* msg);
};

const ::Protocol::PlayerInfo&
S_CHAT::_Internal::playerinfo(const S_CHAT* msg) {
  return *msg->_impl_.playerinfo_;
}
void S_CHAT::clear_playerinfo() {
  if (GetArenaForAllocation() == nullptr && _impl_.playerinfo_ != nullptr) {
    delete _impl_.playerinfo_;
  }
  _impl_.playerinfo_ = nullptr;
...
class REQUEST_ENTER_GAME::_Internal {
 public:
  static const ::Protocol::C_ENTER_GAME& packet(const REQUEST_ENTER_GAME* msg);
};

const ::Protocol::C_ENTER_GAME&
REQUEST_ENTER_GAME::_Internal::packet(const REQUEST_ENTER_GAME* msg) {
...
REQUEST_ENTER_GAME::REQUEST_ENTER_GAME(const REQUEST_ENTER_GAME& from)
  ...
  if (from._internal_has_packet()) {
    _this->_impl_.packet_ = new ::Protocol::C_ENTER_GAME(*from._impl_.packet_);
  }
  // @@protoc_insertion_point(copy_constructor:Protocol.REQUEST_ENTER_GAME)
}

inline void REQUEST_ENTER_GAME::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
REQUEST_ENTER_GAME::~REQUEST_ENTER_GAME() {
  // @@protoc_insertion_point(destructor:Protocol.REQUEST_ENTER_GAME)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void REQUEST_ENTER_GAME::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.packet_;
}

void REQUEST_ENTER_GAME::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void REQUEST_ENTER_GAME::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.REQUEST_ENTER_GAME)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* REQUEST_ENTER_GAME::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* REQUEST_ENTER_GAME::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.REQUEST_ENTER_GAME)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.REQUEST_ENTER_GAME)
  return target;
}

size_t REQUEST_ENTER_GAME::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.REQUEST_ENTER_GAME)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData REQUEST_ENTER_GAME::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    REQUEST_ENTER_GAME::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*REQUEST_ENTER_GAME::GetClassData() const { return &_class_data_; }


void REQUEST_ENTER_GAME::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<REQUEST_ENTER_GAME*>(&to_msg);
  auto& from = static_cast<const REQUEST_ENTER_GAME&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.REQUEST_ENTER_GAME)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_packet()) {
    _this->_internal_mutable_packet()->::Protocol::C_ENTER_GAME::MergeFrom(
        from._internal_packet());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void REQUEST_ENTER_GAME::CopyFrom(const REQUEST_ENTER_GAME& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.REQUEST_ENTER_GAME)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool REQUEST_ENTER_GAME::IsInitialized() const {
  return true;
}

void REQUEST_ENTER_GAME::InternalSwap(REQUEST_ENTER_GAME* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
